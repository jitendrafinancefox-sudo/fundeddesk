'use client';
export const DRAWING_TYPES = ['trend', 'hline', 'vline', 'horizontalRay', 'infoLine', 'rect', 'rotatedRect', 'circle', 'ellipse', 'triangle', 'supplyZone', 'demandZone', 'smcZone', 'premiumDiscountZone', 'parallelChannel', 'flatTopChannel', 'flatBottomChannel', 'disjointChannel', 'regressionChannel', 'linearRegressionChannel', 'ray', 'extended', 'text', 'arrow', 'arrowMarkUp', 'arrowMarkDown', 'measure', 'fib', 'brush', 'pitchfork'];
