...
export default function PropertiesPanel({ drawing, onStyle, onFib, onPosition, onText, onTextLive, onFlip, onLockToggle, onPointEdit, onClose }) {
  ...
  const [extendLeft, setExtendLeft] = useState(drawing.style?.extendLeft ?? isZoneType(drawing.drawingType));
  const [extendRight, setExtendRight] = useState(drawing.style?.extendRight ?? isZoneType(drawing.drawingType));
