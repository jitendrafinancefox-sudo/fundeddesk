...
import { Wallet, TrendingUp, TrendingDown, Minus, AlertTriangle, Activity } from 'lucide-react';
    ...
    >
      {kpis.map((kpi, i) => (
        <motion.div
          ...
          whileHover={{ y: -4, boxShadow: 'var(--shadow-md), var(--shadow-glow)', transition: { duration: 0.3, ease: [0.19, 1, 0.22, 1] } }}
        >
