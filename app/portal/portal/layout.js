  ...
  return (
    <div style={{ minHeight: '100vh', background: 'var(--bg)', position: 'relative' }}>
      ...
      <div style={{
        ...
        background: 'rgba(10,12,21,.85)', backdropFilter: 'blur(14px)', position: 'sticky', top: 0, zIndex: 60,
      }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
          <button onClick={toggleTheme} title={dark ? 'Switch to light mode' : 'Switch to dark mode'} style={{
            width: 34, height: 34, borderRadius: 10, border: '1px solid var(--line2)', background: 'var(--card)',
            display: 'grid', placeItems: 'center', cursor: 'pointer', color: dark ? 'var(--muted)' : 'var(--gold)',
          }}>
      ...
      <div style={{ display: 'flex', position: 'relative', zIndex: 1 }} className="portal">
        <aside style={{
          ...
          background: 'linear-gradient(180deg,rgba(20,26,43,.55),rgba(10,12,21,.7))', backdropFilter: 'blur(10px)',
